...
import {
  StyleSheet, View, Text, Image, Platform, TouchableWithoutFeedback, Item, Dimensions, TouchableOpacity,
} from 'react-native';
...
function WorldwideScreen({ navigation }) {
  ...
  useEffect(() => {
    axios.get('http://0.0.0.0:3000/worldwide', { params: { search: 'all' } })
      .then(({ data }) => {
        setVideos(data);
